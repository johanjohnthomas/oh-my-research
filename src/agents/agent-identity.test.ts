...
describe("buildAgentIdentitySection", () => {
  describe("#given an agent name and role description", () => {
    ...
    const result = buildAgentIdentitySection("Sisyphus", "Powerful AI orchestrator for Oh My Research")
    ...
    expect(result).toContain("Powerful AI orchestrator for Oh My Research")
      })

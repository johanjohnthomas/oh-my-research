...
export function getTaskDir(config: Partial<OhMyResearchConfig> = {}): string {
...
export function resolveTaskListId(config: Partial<OhMyResearchConfig> = {}): string {
...
export function listTaskFiles(config: Partial<OhMyResearchConfig> = {}): string[] {

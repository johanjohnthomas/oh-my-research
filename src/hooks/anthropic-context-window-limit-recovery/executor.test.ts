...
import { OhMyResearchConfigSchema } from "../../config"
...
describe("executeCompact lock management", () => {
  ...
  let pluginConfig: ReturnType<typeof OhMyResearchConfigSchema.parse>
  ...
  beforeEach(() => {
    ...
    pluginConfig = OhMyResearchConfigSchema.parse({})
